...
int main() {
    ...
    printf("Double Hash Insert:\n");

    for(int i = 0; i < size; i++) {
        int N = n[i];

        HashTable* ht = create(N * 2); // load factor ~0.5
        ...
        printf("%d %.6f\n", N,
               ((double)(end - start) / CLOCKS_PER_SEC) * 1000000.0 / N);
    ...
    printf("Double Hash Search:\n");

    for(int i = 0; i < size; i++) {
        int N = n[i];

        HashTable* ht = create(N * 2);
        ...
        printf("%d %.6f\n", N,
               ((double)(end - start) / CLOCKS_PER_SEC) * 1000000.0 / ops);
